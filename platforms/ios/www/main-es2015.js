...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FamilyMembers", function() { return FamilyMembers; });
class FamilyMembers {
    constructor(id, firstName, mask) {
        this.id = id;
...
class Mask {
    constructor(name, numberWash, maxWashingMask, isOver) {
        this.name = name;
...
const routes = [
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | home-home-module */[__webpack_require__.e("common"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: '',
        redirectTo: 'home',
    ...
    {
        path: 'family',
        loadChildren: () => __webpack_require__.e(/*! import() | family-family-module */ "common").then(__webpack_require__.bind(null, /*! ./family/family.module */ "./src/app/family/family.module.ts")).then(m => m.FamilyPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'login',
    ...
    {
        path: 'mask',
        loadChildren: () => __webpack_require__.e(/*! import() | mask-mask-module */ "mask-mask-module").then(__webpack_require__.bind(null, /*! ./mask/mask.module */ "./src/app/mask/mask.module.ts")).then(m => m.MaskPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'my-account',
        loadChildren: () => __webpack_require__.e(/*! import() | my-account-my-account-module */ "my-account-my-account-module").then(__webpack_require__.bind(null, /*! ./my-account/my-account.module */ "./src/app/my-account/my-account.module.ts")).then(m => m.MyAccountPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
];
...
let AppComponent = class AppComponent {
    constructor(tokenStorageService, platform, splashScreen, statusBar, router, userService, alertCtrl, toastController, authGuardService) {
...
AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_token_storage_service__WEBPACK_IMPORTED_MODULE_8__["TokenStorageService"],
...
/* harmony import */ var _family_family_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./family/family.page */ "./src/app/family/family.page.ts");
/* harmony import */ var _mask_mask_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./mask/mask.page */ "./src/app/mask/mask.page.ts");
...
/* harmony import */ var _helper_auth_interceptor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./_helper/auth.interceptor */ "./src/app/_helper/auth.interceptor.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"],
            _family_family_page__WEBPACK_IMPORTED_MODULE_10__["FamilyPage"], _mask_mask_page__WEBPACK_IMPORTED_MODULE_11__["MaskPage"]],
        ...
        providers: [
            ...
            _helper_auth_interceptor__WEBPACK_IMPORTED_MODULE_14__["authInterceptorProviders"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _services_familymembers_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/familymembers.service */ "./src/app/services/familymembers.service.ts");
/* harmony import */ var _FamilyMembers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../FamilyMembers */ "./src/app/FamilyMembers.ts");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/user.service */ "./src/app/services/user.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _services_mask_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/mask.service */ "./src/app/services/mask.service.ts");
...
let FamilyPage = class FamilyPage {
    constructor(familymembersService, userService, maskService, router, alertCtrl, formBuilder, loadingController, toastController) {
    ...
    getAllFamilyMembers() {
        this.present();
        const subscription = this.familymembersService.findFamilyMembers().subscribe(value => { console.log(value), this.familyMembersFromDb = value; }, error => { this.dismiss(), this.presentToast(error, 2000); }, () => { this.dismiss(), subscription.unsubscribe(); });
    }
    createFamilyMember() {
        this.present();
        const subscription = this.familymembersService.createFamilyMember(this.member).subscribe(value => this.userService.user.familyMembers.push(value), error => {
            this.dismiss(),
    ...
    deleteMember(idMember) {
        let reset = [];
        this.present();
        const subscription = this.familymembersService.deleteMember(idMember).subscribe(response => { this.userService.user.familyMembers = reset; }, error => {
            this.dismiss(),
                console.log(error),
                this.presentToast(error, 2000);
        }, () => {
    ...
    showAlertDeletedMember(idMember) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const confirm = yield this.alertCtrl.create({
...
FamilyPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-family',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./family.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/family/family.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./family.page.scss */ "./src/app/family/family.page.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_familymembers_service__WEBPACK_IMPORTED_MODULE_2__["FamilymembersService"],
        _services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"],
        _services_mask_service__WEBPACK_IMPORTED_MODULE_6__["MaskService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaskPage", function() { return MaskPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _services_mask_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/mask.service */ "./src/app/services/mask.service.ts");
/* harmony import */ var _Mask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Mask */ "./src/app/Mask.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _services_familymembers_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/familymembers.service */ "./src/app/services/familymembers.service.ts");
...
let MaskPage = class MaskPage {
    constructor(maskService, familymembersService, alertCtrl, formBuilder, loadingController) {
        this.maskService = maskService;
        this.familymembersService = familymembersService;
        this.alertCtrl = alertCtrl;
        this.formBuilder = formBuilder;
    ...
    getFirstNameMember() {
        const subscription = this.familymembersService.getFirstName(this.idMemberFamily).subscribe(value => { this.firstNameMember = value; }, error => { console.log(error); }, () => {
    ...
    createMask() {
        this.present();
        const subscription = this.maskService.createMask(this.idMemberFamily, this.mask).subscribe(value => { console.log(value); }, error => {
            this.dismiss(),
    ...
    getMaskOfMember() {
        this.present();
        const subscription = this.maskService.findMaskByMember(this.idMemberFamily).subscribe(value => { this.masksOfMember = value; }, error => { this.dismiss(); }, () => { this.dismiss(), console.log(this.masksOfMember), subscription.unsubscribe(); });
    }
    addWashToMask(idMask) {
        this.present();
        const subscription = this.maskService.addWashToMask(idMask).subscribe(value => { this.isSubmit = true; }, error => { this.dismiss(); }, () => { this.dismiss(), this.getMaskOfMember(), this.isSubmit = false, subscription.unsubscribe(); });
    }
    sousWashToMask(idMask) {
        this.present();
        const subscription = this.maskService.sousWashToMask(idMask).subscribe(value => { this.isSubmit = true; }, error => { this.dismiss(); }, () => { this.dismiss(), this.getMaskOfMember(), this.isSubmit = false, subscription.unsubscribe(); });
    }
    deleteMask(idMask) {
        this.present();
        const subscription = this.maskService.deleteMask(idMask).subscribe(response => { console.log(response); }, error => { this.dismiss(), console.log(error); }, () => { this.getMaskOfMember(), this.dismiss(), subscription.unsubscribe(); });
    }
    showAlertDeletedMask(idMask) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const confirm = yield this.alertCtrl.create({
                header: 'Delete mask',
                message: 'Are you sure?',
...
MaskPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-mask',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./mask.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/mask/mask.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./mask.page.scss */ "./src/app/mask/mask.page.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_mask_service__WEBPACK_IMPORTED_MODULE_2__["MaskService"],
        _services_familymembers_service__WEBPACK_IMPORTED_MODULE_6__["FamilymembersService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FamilymembersService", function() { return FamilymembersService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
FamilymembersService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] }
];
FamilymembersService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]])
